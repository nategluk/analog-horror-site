...
| Последний этап | Готово: фиксированный лист и размер иллюстрации; runtime заполняет доступную область текстом по реальным DOM-размерам и переносит остаток без повторения изображения. Mobile 22/22 без overflow и потерь текста; desktop фиксированный лист и кнопки сохранены. Node, diff и public build прошли. |
