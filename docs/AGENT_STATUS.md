...
| Дерево | dirty: архивные preview-кропы + перестановка материалов в досье SZ-312 + preview Ирины + новый протокол коррекции возраста |
| Активная линия | Протокол KIDULTS: книжный reader со свайпом, hash-пагинацией и иллюстрациями |
| Последний этап | Готово: добавлены staff-only маршрут `documents/protocol-kidults`, 5 вертикальных WebP-иллюстраций и квадратный preview; текст разбит runtime на 15 страниц без длинного scroll. В тексте протокола слово KIDULTS не используется: оно осталось в названии и технических идентификаторах. Guest-lock, archive-card, desktop и mobile `390×844`, свайп, клавиши, hash и overflow проверены; build, public verifier, Node и diff прошли. |
