...
| Активная линия | UX книги «Книга Сладкого Сна»: фиксированная измеряемая пагинация |
| Последний этап | Готово: фиксированный лист и размер иллюстрации; runtime заполняет доступную область текста по реальным DOM-размерам целыми предложениями, без повторения заголовка. Служебные PLATE-подписи и «часть N/N» удалены. Desktop и mobile `390×844`: второй разворот без overflow, без повторного заголовка и без разрыва предложения; Node и diff прошли. Публичные названия архивных протоколов обновлены на THERAPY / AFTERMATH / PLAYGROUND / FAITH / CONDUIT; URL и slugs сохранены. Для всех пяти карточек архива добавлены квадратные WebP-превью 1254×1254; старые документные иллюстрации сохранены. |
