...
| Дерево | dirty: архив + досье SZ-312 mugshot и close-up маски |
| Активная линия | Досье Проводницы: кадровый mugshot |
| Последний этап | В `dossier-sz-312` первым стоит 3:2 mugshot (16:9 обрезан по бокам под остальные кадры). Превью личного дела — квадратный close-up маски Солнца. `390×844`: архив и документ, overflow-x 0, console 0. |
