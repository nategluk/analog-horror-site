...
| Дерево | dirty: book-sweet-dream — 20 страниц: пластина + целая глава |
| Активная линия | Архив: ридер «Книги Сладкого Сна» |
| Последний этап | 40 микространиц убраны. 10 глав × (картинка, затем весь текст). «ПРОДОЛЖЕНИЕ» больше не режет главу. |
