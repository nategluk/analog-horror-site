...
| Дерево | dirty: архив — превью у всех трёх ячеек |
| Активная линия | Мобильный архив: печатные издания |
| Последний этап | «Книга Сладкого Сна» в ячейке изданий получила ту же карточку: обложка слева на высоту текста, без ACCESS. `390×844` `#books`: cover loaded, рамка = текст, overflow-x 0, console 0. |
