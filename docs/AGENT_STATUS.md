...
| Дерево | dirty: KIDULTS typography + balanced pagination |
| Активная линия | Протокол KIDULTS: увеличение шрифта и равномерная пагинация |
| Последний этап | KIDULTS: основной текст 17px / 1.5, выравнивание сверху; opt-in balanced pagination с предпочтением целых абзацев. На 390×844 — 16 листов, overflow 0 на всех; первая глава 576/582 знака на текстовых листах. Визуально проверены текст и иллюстрированный лист, клавиши/hash работают; console errors/warnings 0. QA на временной копии HTML со staff-mode без app.js; копия удалена. Node и diff прошли. Остальные книги сохраняют прежнюю пагинацию. |
