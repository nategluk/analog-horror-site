...
| Дерево | dirty: удаление фото-рубрики из archive; сюжетные фото сохранены |
| Активная линия | Архив: удаление верхнеуровневой фото-рубрики |
| Последний этап | Из гостевого и STAFF-архива удалена отдельная фото-категория; фото остаются контекстными материалами звонка Ирины и сюжетных экранов. Production build/verify, desktop и mobile archive QA пройдены. |
