...
| Дерево | dirty: book-sweet-dream — 40 страниц: пластина + текст |
| Активная линия | Архив: ридер «Книги Сладкого Сна» |
| Последний этап | Каждая из 10 иллюстраций — отдельный лист перед главой. Текст без картинки. Mobile `390×844`: plate 01/40, далее текстовая 02/40 без пластины, overflow 0. |
