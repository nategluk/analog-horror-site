...
| Дерево | dirty: уточнение описания «Книги Сладкого Сна» и ссылка из protocol-avd-312-17 |
| Активная линия | Лор: связка протокола Адептов с «Книгой Сладкого Сна» |
| Последний этап | В карточке архива и предисловии книги заменена формулировка о группах, а протокол получил ссылку на книгу с объяснением её культовой роли. Production build/verify пройдены. |
