...
| Дерево | dirty: book-sweet-dream — обложка + предисловие редакции |
| Активная линия | Архив: ридер «Книги Сладкого Сна» |
| Последний этап | Шапка/предисловие сняты с каждого листа. 22 страницы: обложка, предисловие редакции, затем 10×(пластина+глава). Cover WebP 682×1024. |
