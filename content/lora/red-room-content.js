(() => {
  ...
  const nodes = {
    ...
    fox_oleg: {
      ...
      speaker: "ЛИСА",
      line: "Мне обещали новый уровень, если приведу Олега.\nЖурналист. Дёрганый. Обычно таскает сломанный микрофон.\nНе заходил?",
      guest: "fox",
      props: ["note"],
      choices: [
    ...
    fox_why: {
      ...
      visual: "V06_FOX_ACTION",
      speaker: "ЛИСА",
      line: "Слишком часто совал микрофон в служебные двери.\nТеперь Администрация хочет поговорить с ним без микрофона.",
      guest: "fox",
      props: ["note"],
      autoNext: "fox_monopoly",
      delay: 500,
    ...
    fox_leave: {
      ...
      visual: "V06_FOX_ACTION",
      speaker: "ЛИСА",
      line: "Вот мой внутренний. Увидишь нервного с микрофоном — набери.\nЯ буду рядом.",
      guest: "fox",
      props: ["note", "phone"],
      set: ["foxLeftNumber"],
      sound: "door",
    ...
    dog_after_name: {
      ...
      visual: "V07_DOG_BLANK",
      speaker: "ПЁС",
      line: "Не говори так. У меня от этого имени зубы сводит.",
      guest: "dog",
      props: ["note", "phone", "mic"],
      choices: [
