(() => {
  ...
  const nodes = {
    ...
    fox_enter: {
      ...
      visual: "V05_FOX_GAZE",
      speaker: "ЛИСА",
      line: "Свет не трогай. Мне так лучше видно.\nЛоры нет? Норм. С ней вечно эти правила.\nМожно закурить? Ладно, это не вопрос.",
      guest: "fox",
      props: ["note"],
      choices: [
        { id: "fox_hello", text: "Чем могу помочь?", next: "fox_smell" },
        { id: "fox_no_film", text: "Убрать камеру.", next: "fox_camera" },
        { id: "fox_no_smoke", text: "Здесь нельзя курить.", next: "fox_smell", set: ["foxToldNoSmoke"] },
      ],
    },
    fox_camera: {
      scene: "counter",
    ...
    fox_smell: {
      ...
      lineWhen: [
        {
          require: ["foxToldNoSmoke", "pigToyTaken"],
          line: "Ты сказал нельзя. Я услышала.\nА это ещё что, на цепи. Карманный детский сад?",
        },
        {
          require: ["pigToyTaken"],
        ...
        {
          require: ["foxToldNoSmoke", "pigToyOffered"],
          line: "Ты сказал нельзя. Я услышала.\nИ это ещё что, на цепи.",
        },
        {
          require: ["foxToldNoSmoke"],
          line: "Ты сказал нельзя. Я услышала.\nЗдесь пахнет мокрым костюмом. Кто был?",
        },
        {
          require: ["pigToyOffered"],
