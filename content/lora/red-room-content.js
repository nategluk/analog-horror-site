(() => {
  ...
  const nodes = {
    ...
    pig_source: {
      ...
      visual: "V02_PIG_MASKED",
      speaker: "ХРЮША",
      line: "Заяц. Спортсмен. Он уже был здесь. ",
      guest: "pig",
      props: ["note"],
      set: ["pigAskedSource"],
      choices: [
    ...
    fox_lights_up: {
      ...
      visual: "V05_FOX_GAZE",
      speaker: "Я",
      line: "Интересно, как она вылезла из горки в абсолютно сухой шубе",
      guest: "fox",
      props: ["note"],
      autoNext: "fox_notice",
      delay: 700,
    ...
    fox_smell: {
      ...
      lineReplay: "Рассказывай! От того, врешь ты мне или нет, \nзависит встретимся мы снова. Или нет. ",
      guest: "fox",
      props: ["note"],
      choices: [
        {
    ...
    fox_gave_wait: {
      ...
      visual: "V05_FOX_GAZE",
      speaker: "АЛИСА",
      line: "Он - не тот, кто мне сейчас нужен. Я ищу другого",
      guest: "fox",
      props: ["note"],
      foxOutcome: "cooperated",
      autoNext: "fox_oleg",
    ...
    dog_hospital: {
      ...
      visual: "V07_DOG_BLANK",
      speaker: "ДРУЖОК",
      line: "Это мое новое место работы?",
      guest: "dog",
      props: ["note", "phone", "mic"],
      choices: [
    ...
    dog_settled: {
      ...
      visual: "V08_DOG_SETTLED",
      speaker: "ДРУЖОК",
      line: "Я начинаю что-то вспоминать Задай мне ещё один вопрос? Короткий.",
      guest: "dog",
      props: ["note", "phone", "mic"],
      choices: [
        {
    ...
    dog_after_name: {
      ...
      visual: "V07_DOG_BLANK",
      speaker: "ДРУЖОК",
      line: "Почему я здесь? Я уже не ребенок. Я взрослая собака",
      guest: "dog",
      props: ["note", "phone", "mic"],
      choices: [
    ...
    end_give_leave: {
      ...
      props: ["note"],
      sound: "door",
      autoNext: "end_give_album",
      delay: 800,
    },
    end_give_album: {
      scene: "counter",
      visual: "V17_FOX_ALBUM",
      speaker: "Я",
      line: "В альбоме ещё есть пустые страницы.",
      props: ["note"],
      hideHtmlProps: true,
      autoNext: "aftermath",
      delay: 700,
    ...
    end_sea: {
      ...
      visual: "V09_DOG_CURTAIN",
      speaker: "ВЫ",
      line: "В подсобке есть горка. Она пахнет морем.",
      guest: "dog",
      props: ["note", "mic"],
      autoNext: "end_sea_go",
      delay: 500,
    ...
    end_sea_go: {
      ...
      visual: "V09_DOG_CURTAIN",
      speaker: "ДРУЖОК",
      line: "Море? Ты же в курсе, что горки меняют цвет и запах каждые полчаса?",
      guest: "dog",
      props: ["note"],
      sound: "door",
