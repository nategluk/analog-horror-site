(() => {
  ...
  const nodes = {
    ...
    pig_arrive: {
      ...
      visual: "V01_EMPTY_COUNTER",
      speaker: "Я",
      line: "Первый гость и сразу свинья. Какое везение!",
      guest: "pig",
      props: ["note"],
      sound: "door",
      autoNext: "pig_enter",
    ...
    pig_reveal: {
      ...
      speaker: "Я",
      line: "Хмм... а под маской ничего такой.",
      guest: "pig",
      props: ["note"],
      set: ["pigRevealed"],
      choices: [
    ...
    pig_bargain: {
      ...
      speaker: "ХРЮША",
      line: "Слушай. У меня вот это. Ключ мне — кадило тебе. И я сразу уйду, честно.",
      guest: "pig",
      props: ["note", "toy"],
      inspect: "toy",
      set: ["pigToyOffered"],
    ...
    fox_arrive: {
      ...
      visual: "V05_FOX_GAZE",
      speaker: "Я",
      line: "От неё пахнет сладкой ватой. Чувствую, это будет сложный посетитель.",
      guest: "fox",
      props: ["note"],
      sound: "door",
      autoNext: "fox_enter",
    ...
    fox_enter: {
      ...
      choices: [
        ...
        { id: "fox_light_on", text: "Меня Лора попросила", next: "fox_laura" },
      ],
    },
    fox_laura: {
      scene: "counter",
