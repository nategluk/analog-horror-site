    ...
    "system-profile-created": {
      ...
      body: (profile) =>
        profile.role === "impostor"
          ? `${profile.displayName || "Оператор"}, ночной вход записан отдельно от кадровой проверки.\n\nНазначение отсутствует. Укажите имя для этой записи и выберите изображение, если хотите оставить её.`
