(() => {
  ...
  const nodes = {
    ...
    "park-grounds": {
      speaker: "Я",
      text: "Cолнце светит даже непослушным детям. \nНо только не здесь. ",
      ...
      mediaFallback: "Необязательно быть малышом, чтобы любить парки. Наверное. ",
      choices: [
    ...
    "empty-carousel": {
      speaker: "Я",
      text: "Вайб как в мультиках из альманаха \"Тихая карусель\"",
    ...
    "irina-thanks": {
      ...
      action: "Она улыбается так, словно хочет меня о чем-то попросить",
      media: {
        id: "irina-cotton-b",
        loop: false,
