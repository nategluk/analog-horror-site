(() => {
  ...
  const curatorNodes = {
    ...
    "adult-certainty": {
      ...
      text: (progress) =>
        progress.flags.questionsAdultStatus
          ? "Нужно точно. Центр хранит детский возраст отдельно от тела. Ты сейчас говоришь со мной как бывший ребёнок?"
    ...
    "adult-ack": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Хорошо. Бывший ребёнок. С вами мне можно разговаривать. Настоящих передают Старшему Проводнику. Зачем ты вернулся?",
      choices: [
        {
    ...
    "adult-reason": {
      ...
      text: (progress) => {
        if (progress.flags.returnsForMemory) {
          return "Ты пришёл правильно. Здесь хранят детство, забытое у входа. Иногда оно портится, если долго не забирать.";
        }
    ...
    "orientation-two": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Да. Возвращение — когда место помнит тебя лучше. Ты узнаёшь запах или музыку. Потом находится старый маршрут.",
      choices: [
        {
    ...
    "role-volunteer": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Волонтёр приходит сам и ищет то, чего нет в маршруте. Ему разрешено смотреть. Уходить — отдельное разрешение.",
      choices: [
        {
          label: "Я ПОНЯЛ",
          next: "class-briefing-one",
    ...
    "class-briefing-two": {
      ...
      text: (progress) =>
        progress.flags.askedWhoCanLeave
          ? "Волонтёр может попросить выход. Аниматор сначала сдаёт смену. Иначе непонятно, кто просится: человек или оболочка."
          : "Волонтёру можно смотреть на двери, журналы и лица. Аниматору необязательно: маршрут поворачивает его тело сам.",
      choices: [
        {
    ...
    "parents-rule-one": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Пять минут — не время, а обещание. Пока ребёнок ждёт на месте, родители считаются возвращающимися.",
      choices: [
        {
    ...
    "parents-rule-two": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Иначе ребёнка пришлось бы считать оставленным. Это другая форма: цена входа, класс и добровольность передачи.",
      choices: [
        {
    ...
    "drawing-history": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Такие рисунки находят в старых квартирах и комнатах ожидания. Дверь считают согласием войти. Взрослых у края — ушедшими.",
      choices: [
        {
    ...
    "wristband-response": {
      ...
      text: (progress) => {
        ...
        return "Ты выбрал завтрашний маршрут. Волонтёры умеют идти по следу до того, как он официально появился.";
      },
      choices: [
        {
    ...
    "wristband-explain": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Выданные вещи существуют раньше получателя. Браслет, маска или игрушка сначала появляются в учёте, потом ждут тело.",
      choices: [
        {
          label: "ПРОДОЛЖИТЬ",
    ...
    "cycle-history-two": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Возраст не должен мешать должности. У Волонтёра он в пропуске, у Аниматора — в оболочке. Мой дом тоже хранится отдельно.",
      choices: [
        {
    ...
    "cycle-history-three": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Родители устроили меня сюда: работа безопаснее дома. Я не должна проверять их решение. Это была личная фраза. Забудь её.",
      choices: [
        {
    ...
    "ulybarych-history-two": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Взрослые узнают музыку и улыбаются раньше команды. Улыбарыч зовёт это остаточным детством. Канал уже не переключают.",
      choices: [
        {
    ...
    "pass-history-one": {
      ...
      speaker: "ИРИНА В.",
      text:
        "Первый пропуск всегда немного неправильный. Камера снимает не лицо, а то, с чем человек войдёт в Лосиный Остров.",
      choices: [
        {
    ...
    "pass-history-two": {
      ...
      speaker: "ИРИНА В.",
      text:
        "На моём был Медведь. Я ещё не выбрала его, но родители назвали фотографию удачной. Вторую мне не показывают.",
      choices: [
        {
    ...
    "return-memory-one": {
      ...
      text: (progress) => {
        ...
        return `${drawingCallback} ${fileCallback} Это было не для должности. Я проверяла, останется ли разговор снаружи.`;
      },
      choices: [
        {
    ...
    "return-memory-two": {
      ...
      text: (progress) =>
        progress.flags.promisesToRememberCall
          ? "Хорошо. Тогда у звонка будет копия снаружи. Это почти как друг, которому не нужно отвечать каждый день."
    ...
    "assignment-role": {
      ...
      text: (progress) =>
        getCuratorAssignment(progress) === "volunteer"
          ? "Волонтёр. Ты ищешь цель без назначения. Тебе выдадут театральную маску и доступ к следующему уровню."
    ...
    "assignment-keepsake": {
      ...
      text: (progress) => {
        if (progress.flags.acceptedPrivatePhoto) {
          return "Фотографию оставь у себя. Если канал попросит удалить её, сначала запомни лицо. Так будет правильнее.";
        }
